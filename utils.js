...
class StalksAlgorithm {
    ...
    static calculateGuaFromYaos(yaos) {
        ...
        const guas = [
            ...
            { binary: '100010', symbol: '䷂', seq: 3, sname: "屯", name: "水雷屯" },
            { binary: '010001', symbol: '䷃', seq: 4, sname: "蒙", name: "山水蒙" },
            { binary: '111010', symbol: '䷄', seq: 5, sname: "需", name: "水天需" },
            { binary: '010111', symbol: '䷅', seq: 6, sname: "讼", name: "天水讼" },
            { binary: '010000', symbol: '䷆', seq: 7, sname: "师", name: "地水师" },
            { binary: '000010', symbol: '䷇', seq: 8, sname: "比", name: "水地比" },
            { binary: '111011', symbol: '䷈', seq: 9, sname: "小畜", name: "风天小畜" },
            { binary: '110111', symbol: '䷉', seq: 10, sname: "履", name: "天泽履" },
            { binary: '111000', symbol: '䷊', seq: 11, sname: "泰", name: "天地泰" },
            { binary: '000111', symbol: '䷋', seq: 12, sname: "否", name: "地天否" },
            { binary: '101111', symbol: '䷌', seq: 13, sname: "同人", name: "天火同人" },
            { binary: '111101', symbol: '䷍', seq: 14, sname: "大有", name: "火天大有" },
            { binary: '001000', symbol: '䷎', seq: 15, sname: "谦", name: "地山谦" },
            { binary: '000100', symbol: '䷏', seq: 16, sname: "豫", name: "雷地豫" },
            { binary: '100110', symbol: '䷐', seq: 17, sname: "随", name: "泽雷随" },
            { binary: '011001', symbol: '䷑', seq: 18, sname: "蛊", name: "山风蛊" },
            { binary: '110000', symbol: '䷒', seq: 19, sname: "临", name: "地泽临" },
            { binary: '000011', symbol: '䷓', seq: 20, sname: "观", name: "风地观" },
            { binary: '100101', symbol: '䷔', seq: 21, sname: "噬嗑", name: "火雷噬嗑" },
            { binary: '101001', symbol: '䷕', seq: 22, sname: "贲", name: "山火贲" },
            { binary: '000001', symbol: '䷖', seq: 23, sname: "剥", name: "山地剥" },
            { binary: '100000', symbol: '䷗', seq: 24, sname: "复", name: "地雷复" },
            { binary: '100111', symbol: '䷘', seq: 25, sname: "无妄", name: "天雷无妄" },
            { binary: '111001', symbol: '䷙', seq: 26, sname: "大畜", name: "山天大畜" },
            ...
            { binary: '001110', symbol: '䷞', seq: 31, sname: "咸", name: "泽山咸" },
            { binary: '011100', symbol: '䷟', seq: 32, sname: "恒", name: "雷风恒" },
            { binary: '001111', symbol: '䷠', seq: 33, sname: "遯", name: "天山遯" },
            { binary: '111100', symbol: '䷡', seq: 34, sname: "大壮", name: "雷天大壮" },
            { binary: '000101', symbol: '䷢', seq: 35, sname: "晋", name: "火地晋" },
            { binary: '101000', symbol: '䷣', seq: 36, sname: "明夷", name: "地火明夷" },
            { binary: '101011', symbol: '䷤', seq: 37, sname: "家人", name: "风火家人" },
            { binary: '110101', symbol: '䷥', seq: 38, sname: "睽", name: "火泽睽" },
            { binary: '001010', symbol: '䷦', seq: 39, sname: "蹇", name: "水山蹇" },
            { binary: '010100', symbol: '䷧', seq: 40, sname: "解", name: "雷水解" },
            { binary: '110001', symbol: '䷨', seq: 41, sname: "损", name: "山泽损" },
            { binary: '100011', symbol: '䷩', seq: 42, sname: "益", name: "风雷益" },
            { binary: '111110', symbol: '䷪', seq: 43, sname: "夬", name: "泽天夬" },
            { binary: '011111', symbol: '䷫', seq: 44, sname: "姤", name: "天风姤" },
            { binary: '000110', symbol: '䷬', seq: 45, sname: "萃", name: "泽地萃" },
            { binary: '011000', symbol: '䷭', seq: 46, sname: "升", name: "地风升" },
            { binary: '010110', symbol: '䷮', seq: 47, sname: "困", name: "泽水困" },
            { binary: '011010', symbol: '䷯', seq: 48, sname: "井", name: "水风井" },
            { binary: '101110', symbol: '䷰', seq: 49, sname: "革", name: "泽火革" },
            { binary: '011101', symbol: '䷱', seq: 50, sname: "鼎", name: "火风鼎" },
            { binary: '100100', symbol: '䷲', seq: 51, sname: "震", name: "震为雷" },
            { binary: '001001', symbol: '䷳', seq: 52, sname: "艮", name: "艮为山" },
            { binary: '001011', symbol: '䷴', seq: 53, sname: "渐", name: "风山渐" },
            { binary: '110100', symbol: '䷵', seq: 54, sname: "归妹", name: "雷泽归妹" },
            { binary: '101100', symbol: '䷶', seq: 55, sname: "丰", name: "雷火丰" },
            { binary: '001101', symbol: '䷷', seq: 56, sname: "旅", name: "火山旅" },
            { binary: '011011', symbol: '䷸', seq: 57, sname: "风", name: "巽为风" },
            { binary: '110110', symbol: '䷹', seq: 58, sname: "泽", name: "兑为泽" },
            { binary: '010011', symbol: '䷺', seq: 59, sname: "涣", name: "风水涣" },
            { binary: '110010', symbol: '䷻', seq: 60, sname: "节", name: "水泽节" },
            { binary: '110011', symbol: '䷼', seq: 61, sname: "中孚", name: "风泽中孚" },
            { binary: '001100', symbol: '䷽', seq: 62, sname: "小过", name: "雷山小过" },
            { binary: '101010', symbol: '䷾', seq: 63, sname: "既济", name: "水火既济" },
            { binary: '010101', symbol: '䷿', seq: 64, sname: "未济", name: "火水未济" }]
